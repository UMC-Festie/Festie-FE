        ...
        <ContentContainer>
          <TogetherWrap>
            {!isWriter && isApplicant ? (
              <>
                {status === 0 ? (
                  <MatchingState $isSuccess={isApplicantSuccess}>
                    매칭 중이에요
                  </MatchingState>
                ) : isApplicantSuccess ? (
                  <>
            ...
            <TogetherPost isWriter={isWriter} togetherData={togetherData} />
            {isModalOpen && (
        ...
        {showScrollButton && (
          <ScrollUpButton onClick={onClickScrollToTop}>
            ...
            >
              ...
              />
              <path
                d="M5.83398 14.0007L14.0007 5.83398L22.1673 14.0007"
                stroke="white"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
