    ...
    <div>
      <div className="mainBanner">
        <div style={bannerStyles}>
          ...
          <p className="mainText" style={textmainStyles}>
            축제도 보고, <br /> 친구도 사귀고!
          </p>
          <p className="mainsecondText" style={textStyles}>
            나와 취향이 맞는 친구도 사귀고, 페스티벌 정보도 공유하고! <br />{" "}
            나의 취향과 추억 그리고 정보를 ‘공유’해요
          </p>
          <div className="startBtn" style={btnStyles}>
            시작하기
            <img src={arrowright} />
          </div>
        </div>
      ...
      <div className="main">
        ...
        <span
          className={`maintogetherBtn ${
            selectedTogether === "얼마 남지 않은" ? "clicked" : ""
          }`}
